...
const EncoderManual_1 = __importDefault(require("../src/component/encoder/EncoderManual"));
const EncoderLightManual_1 = __importDefault(require("../src/component/encoder/EncoderLightManual"));
const EncoderJson_1 = __importDefault(require("../src/component/encoder/EncoderJson"));
const Types_1 = __importDefault(require("../src/const/Types"));
const convertToMap = function (arr) {
    const ris = new Map();
...
const compareResultForManual = function (src, dst) {
    console.log("SRC", src);
    console.log("dst", dst);
...
const test_01 = async function () {
    console.log("\n##########   test_01  ##########");
    console.log("\n########## EncoderMix ##########");
    const temp = new EncoderMix_1.default();
    const dirs = [
...
const test_02 = async function () {
    console.log("\n##########    test_02    ##########");
    console.log("\n########## EncoderManual ##########");
    const temp = new EncoderManual_1.default();
    const dirs = [
        { reward: 2, sourceIndex: 3 },
        { reward: 1, sourceIndex: 1 },
        { reward: 1, sourceIndex: 0 },
...
const test_06 = async function () {
    ...
    const temp = new EncoderLightManual_1.default(requestID);
    const dirs = [
        { reward: 2, sourceIndex: 3 },
        { reward: 2, sourceIndex: 1 },
        { reward: 1, sourceIndex: 0 },
...
const test_08 = async function () {
    ...
    console.log("\n########## EncoderJson ##########");
    const requestID = "e9707d0e6171f728f7473c24cc0432a9b07eaaf1efed6a137a4a8c12c79552d9";
    const temp = new EncoderJson_1.default(requestID);
    const dirs = [
        { reward: 2, sourceIndex: 3 },
        { reward: 1, sourceIndex: 1 },
        { reward: 1, sourceIndex: 0 },
    ...
    const ris = temp.decode(encoded);
    console.log("ris", ris);
    return ris.data.value === value && ris.data.type === Types_1.default.POS_INTEGER;
};
const test_09 = async function () {
    ...
    const ris = temp.decode(encoded);
    console.log("ris", ris);
    return ris.data.value === value && ris.data.type === Types_1.default.NEG_FLOAT;
};
const test_10 = async function () {
    ...
    const ris = temp.decode(encoded);
    console.log("ris", ris);
    return ris.data.value === value && ris.data.type === Types_1.default.STRING;
};
exports.default = {
    test_01,
    test_02,
